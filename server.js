...
app.get('/team_stats', function(req, res) {
	...
	var win_games = 'SELECT count(*) from football_games  where home_score > visitor_score;';
	var los_games = 'SELECT count(*) from football_games  where home_score < visitor_score;';
